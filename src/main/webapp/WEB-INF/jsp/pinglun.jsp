...
<body id="body">
	...
	<div class="movie_score" id="movie_score">
		...
		<div class="score_mid">
			...
			<input id="score2" class="score" type="text" name="score"/>
			<span class="s2">简短评论</span>
			<span id="num" class="num">140</span>
			<textarea id="textarea" maxlength="140" name="content"></textarea>
		</div>
	...
	<div class="long">
		...
		<a class="writeshort" id="writelong" href="longView">我要写影评</a>
